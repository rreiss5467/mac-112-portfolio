...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "9 AM Temp", y = "3 PM Temp", title = "Temperature (C) By Location", color = "Location")  
```
...
```{r}
#| fig-cap: "Comparison of 9 AM v/s 3 PM temperatures in degrees Celcius by location."

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "9 AM Temp (C)", y = "3 PM Temp (C)", color = "Location")  
```
